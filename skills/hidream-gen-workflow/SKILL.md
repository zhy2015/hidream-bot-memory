...
- **默认交付邮箱**: `user@example.com` (根据 USER.md 规则)。
...
- **如果是视频 (.mp4) 或其他富媒体**:
  ...
  ```bash
  export QQMAIL_USER="your_email@qq.com" && export QQMAIL_AUTH_CODE="your_auth_code" && python3 /root/.openclaw/workspace/skills/qqmail/scripts/qqmail.py send --to "user@example.com" --subject "Generated Media Content" --body "您的多模态内容已生成，请查看附件。" --attachment "downloads/viva_gen_output.mp4"
  ```
